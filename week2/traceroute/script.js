...
function preload() {
  data = loadTable('./data/ip_location.csv', 'csv', 'header');
}
...
　console.log(data);
  ...
  //console.log(data.getString(currentMeteorite, 'reclat'));
//   for(var i=0; i<15; i++) {
//     meteorites.addMeteorite(data.getString(currentMeteorite, 'reclat'), data.getString(currentMeteorite, 'reclong'), 10);
//   }
...
function draw(){
  ...
  for(var i=0; i<data.length; i++) {
      console.log(data[i].reclat);
      console.log(data[i].reclong);
    //   if(i<meteorites.length-1) {
